                    ...
                    if (!this.checkDate[index].chcked) {
                        ...
                        // this.toggleColor(false,index);
                            if (index==0) {
                                ...
                                if (this.checkDate[5].chcked==false) {
                                    this.checkDate[6].disable=false;
                                }
                                if (this.checkDate[2].chcked==false) {
                                    this.checkDate[1].disable=false;
                                } 


                            } else if(index==1) {
                                if (this.checkDate[6].chcked==false) {
                                    this.checkDate[0].disable=false;
                                }
                                if (this.checkDate[3].chcked==false) {
                                    this.checkDate[2].disable=false;
                                } 
                                ...
                                if (this.checkDate[1].chcked==false) {
                                    this.checkDate[2].disable=false;
                                }
                                if (this.checkDate[4].chcked==false) {
                                    this.checkDate[5].disable=false;
                                }
                                ...
                                if (this.checkDate[0].chcked==false) {
                                    this.checkDate[6].disable=false;
                                }
                                if (this.checkDate[3].chcked==false) {
                                    this.checkDate[4].disable=false;
                                }
